...
play_audio() {
    ...
    echo "Debug: Attempting to play: $filename" >&2
    echo "Debug: File exists: $(test -f "$filename" && echo "yes" || echo "no")" >&2
